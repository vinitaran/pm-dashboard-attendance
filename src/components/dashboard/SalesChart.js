  ...
  const chartoptions = {
    series: [
      ...
      },
      {
        name: "R1",
        data: [
          [Date.now() - 6 * 86400000, 6],
          [Date.now() - 5 * 86400000, 7],
          [Date.now() - 4 * 86400000, 4],
          [Date.now() - 3 * 86400000, 6],
          [Date.now() - 2 * 86400000, 5],
          [Date.now() - 86400000, 9],
          [Date.now() , 8],
        ],
      },
      {
        name: "PM Dashboard",
        data: [
          [Date.now() - 6 * 86400000, 4],
          [Date.now() - 5 * 86400000, 2],
          [Date.now() - 4 * 86400000, 1],
          [Date.now() - 3 * 86400000, 2],
          [Date.now() - 2 * 86400000, 3],
          [Date.now() - 86400000, 5],
          [Date.now() , 4],
        ],
      },
